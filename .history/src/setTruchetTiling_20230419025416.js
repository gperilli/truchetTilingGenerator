    ...
    for (let y = 0; y < truchetRows; y++) {
        for (let x = 0; x < truchetRows; x++) {
            if (tileMatrix[y][x].backPiece.colorGroup.length == 1) {
                if (topLevelContiguousGroups.includes(tileMatrix[y][x].backPiece.colorGroup[0]) == false) {
                    topLevelContiguousGroups.push(tileMatrix[y][x].backPiece.colorGroup[0]);
                }
            }
            ...
            if (tileMatrix[y][x].cornerPieceBottom.colorGroup.length == 1) {
                if (topLevelContiguousGroups.includes(tileMatrix[y][x].cornerPieceBottom.colorGroup[0]) == false) {
                    topLevelContiguousGroups.push(tileMatrix[y][x].cornerPieceBottom.colorGroup[0]);
                }
            }
            ...
            if (tileMatrix[y][x].cornerPieceTop.colorGroup.length == 1) {
                if (topLevelContiguousGroups.includes(tileMatrix[y][x].cornerPieceTop.colorGroup[0]) == false) {
                    topLevelContiguousGroups.push(tileMatrix[y][x].cornerPieceTop.colorGroup[0]);
                }
            }
