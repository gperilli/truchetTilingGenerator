...
class TruchetTile {
    ...
    init() {
        this.drawPieSlice({ centreX: this.tileWidth, centreY: this.tileWidth, startAngleRadians: Math.PI , sweepAngleRadians: Math.PI / 2, radius: this.tileWidth / 2, fillColour: "#000" } );
        this.drawPieSlice({ centreX: this.tileWidth, centreY: this.tileWidth, startAngleRadians: Math.PI , sweepAngleRadians: Math.PI / 2, radius: (this.tileWidth / 2) - 5, fillColour: "#FFF" } );
        this.drawPieSlice({ centreX: 0, centreY: 0, startAngleRadians: 0 , sweepAngleRadians: Math.PI / 2, radius: this.tileWidth / 2, fillColour: "#000" } );
        this.drawPieSlice({ centreX: 0, centreY: 0, startAngleRadians: 0 , sweepAngleRadians: Math.PI / 2, radius: (this.tileWidth / 2) - 5, fillColour: "#FFF" } );
