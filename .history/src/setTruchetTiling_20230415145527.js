        ...
        for (let x = 0; x < truchetRows; x++) {
            ...
            if (tileToTheLeft != null) {
                ...
                if (tileMatrix[y][x].bottomLeftClass == 'truchetBottomLeft' && tileToTheLeft.bottomRightClass == 'truchetBottomRight') {
                    tileMatrix[y][x].cornerPieceBottom.colorGroup.push(tileToTheLeft.cornerPieceBottom.colorGroup);
                } else if (tileMatrix[y][x].bottomLeftClass == 'truchetBottomLeft' && tileToTheLeft.bottomRightClass == 'truchetBottomRightToTopLeftBack') {
                    tileMatrix[y][x].cornerPieceBottom.colorGroup.push(tileToTheLeft.backPiece.colorGroup);
                } else if (tileMatrix[y][x].bottomLeftClass == 'truchetBottomLeftToTopRightBack' && tileToTheLeft.bottomRightClass == 'truchetBottomRight') {
                    tileMatrix[y][x].backPiece.colorGroup.push(tileToTheLeft.cornerPieceBottom.colorGroup);
                    ...
                    tileMatrix[y][x].backPiece.colorGroup.push(tileToTheLeft.backPiece.colorGroup);
                }

                if (tileMatrix[y][x].topLeftClass == 'truchetTopLeft' && tileToTheLeft.topRightClass == 'truchetTopRight') {
                    tileMatrix[y][x].cornerPieceTop.colorGroup.push(tileToTheLeft.cornerPieceTop.colorGroup);
                } else if (tileMatrix[y][x].topLeftClass == 'truchetTopLeft' && tileToTheLeft.topRightClass == 'truchetBottomLeftToTopRightBack') {
                    tileMatrix[y][x].cornerPieceTop.colorGroup.push(tileToTheLeft.backPiece.colorGroup);
                } else if (tileMatrix[y][x].topLeftClass == 'truchetBottomRightToTopLeftBack' && tileToTheLeft.topRightClass == 'truchetTopRight') {
                    tileMatrix[y][x].backPiece.colorGroup.push(tileToTheLeft.cornerPieceTop.colorGroup);
            ...
            if (tileAbove != null) {
                ...
                if (tileMatrix[y][x].topLeftClass == 'truchetTopLeft' && tileAbove.bottomLeftClass == 'truchetBottomLeft') {
                    tileMatrix[y][x].cornerPieceTop.colorGroup.push(tileAbove.cornerPieceBottom.colorGroup);
                } else if (tileMatrix[y][x].topLeftClass == 'truchetTopLeft' && tileAbove.bottomLeftClass == 'truchetBottomLeftToTopRightBack') {
                    tileMatrix[y][x].cornerPieceTop.colorGroup.push(tileAbove.backPiece.colorGroup);
                } else if (tileMatrix[y][x].topLeftClass == 'truchetBottomRightToTopLeftBack' && tileAbove.bottomLeftClass == 'truchetBottomLeft') {
                    tileMatrix[y][x].backPiece.colorGroup.push(tileAbove.cornerPieceBottom.colorGroup);
                    ...
                    tileMatrix[y][x].backPiece.colorGroup.push(tileAbove.backPiece.colorGroup);
                }
                ...
                if (tileMatrix[y][x].topRightClass == 'truchetTopRight' && tileAbove.bottomRightClass == 'truchetBottomRight') {
                    ...
                    tileMatrix[y][x].cornerPieceTop.colorGroup.push(tileAbove.backPiece.colorGroup);
                } else if (tileMatrix[y][x].topRightClass == 'truchetBottomLeftToTopRightBack' && tileAbove.bottomLeftClass == 'truchetBottomRight') {
                    tileMatrix[y][x].backPiece.colorGroup.push(tileAbove.cornerPieceBottom.colorGroup);
                } else if (tileMatrix[y][x].topRightClass == 'truchetBottomLeftToTopRightBack' && tileAbove.bottomLeftClass == 'truchetBottomRightToTopLeftBack') {
                    tileMatrix[y][x].backPiece.colorGroup.push(tileAbove.backPiece.colorGroup);
                }
