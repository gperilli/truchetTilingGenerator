...
class TruchetTile {
    ...
    createTileA()
    {
        this.createPieSlice({ centreX: this.tileWidth, centreY: this.tileWidth, startAngleRadians: Math.PI / 2, sweepAngleRadians: 0, radius: (this.tileWidth / 2) + (this.strokeWidth / 2), fillColour: "#000" } );
