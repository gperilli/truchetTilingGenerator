    ...
    for (let y = 0; y < truchetRows; y++) {
        for (let x = 0; x < truchetRows; x++) {
            ...
            if (x == 0 && y == 0) {
                ...
                // console.log(tileMatrix[y][x].topLeftClass);
            ...
            } else if (i == (truchetRows - 1) && y == (truchetRows - 1)) {
            ...
            } else if (x == 0 && y > 0 && y != (truchetRows - 1)) {
                // far left column - not top left corner - not bottom left corner
                let tileToTheLeft = null;
            } else if (x > 0 && y == 0 && i != (truchetRows - 1)) {
                // top row - not top left corner - not top right corner
                let tileAbove = null;
            } else if (x > 0 && y > 0 && i != (truchetRows - 1) && y != (truchetRows - 1)) {
