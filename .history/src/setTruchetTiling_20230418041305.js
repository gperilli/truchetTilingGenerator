    ...
    for (let i = 0; i < joinerGroupsToJoinUniqArray.length; i++) {
        ...
        for (let m = 0; m < joinedGroups.length; m++) {
            ...
            for (let l = 0; l < uncheckedGroups.length; l++) {
                //if (joinerGroupsToJoinUniqArray[j].merged == false) {}
                ...
                if (uncheckedGroups[l] != joinerGroupsToJoinUniqArray[i]) {
                    for (let k = 0; k < joinedGroups[m].length; k++) {
                        if ((joinedGroups[m][k] == uncheckedGroups[l][0] || joinedGroups[m][k] == uncheckedGroups[l][1]) && joinerGroupsToJoinUniqArray[j].merged == false) {
                            joinedGroups[m][k].push(uncheckedGroups[l][0]);
                            joinedGroups[m][k].push(uncheckedGroups[l][1]);
        ...
        if (joinerGroupsToJoinUniqArray[i].checked == true && joinerGroupsToJoinUniqArray[i].merged == false) {
