...
function setTruchetTiling(containerSquare, tilingAreaWidthLength, truchetSettings) {
    ...
    console.log(contiguousGroups[10]);

    contiguousGroups[10].forEach((part) => {
        console.log(part.className.baseVal);
        if (part.className == 'truchetBottomLeftToTopRightBack' || part.className == 'truchetBottomRightToTopLeftBack') {
            console.log("bang");
