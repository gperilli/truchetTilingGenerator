...
class TruchetTile {
    ...
    createTileB()
    {
        this.createPieSlice({ centreX: this.tileWidth, centreY: 0, startAngleRadians: 0, sweepAngleRadians: degrees_to_radians(90), radius: (this.tileWidth / 2) + (this.strokeWidth / 2), fillColour: "#000" } );
        this.createPieSlice({ centreX: this.tileWidth, centreY: 0, startAngleRadians: 0, sweepAngleRadians: degrees_to_radians(90), radius: (this.tileWidth / 2) - (this.strokeWidth / 2), fillColour: "#FFF" } );
        //this.createPieSlice({ centreX: 0, centreY: this.tileWidth, startAngleRadians: 0 , sweepAngleRadians: Math.PI / 2, radius: (this.tileWidth / 2) + (this.strokeWidth / 2), fillColour: "#000" } );
        //this.createPieSlice({ centreX: 0, centreY: this.tileWidth, startAngleRadians: 0 , sweepAngleRadians: Math.PI / 2, radius: (this.tileWidth / 2) - (this.strokeWidth / 2), fillColour: "#FFF" } );
    }
