...
class TruchetTile {
    ...
    setTruchetTileDomElements() {
        ...
        if (this.topLeftClass == "truchetBottomRightToTopLeftBack" || "truchetBottomLeftToTopRightBack") {
        ...
        if (this.topRightClass == "truchetBottomRightToTopLeftBack" || "truchetBottomLeftToTopRightBack") {
        ...
        if (this.bottomLeftClass == "truchetBottomRightToTopLeftBack" || "truchetBottomLeftToTopRightBack") {
        ...
        if (this.bottomRightClass == "truchetBottomRightToTopLeftBack" || "truchetBottomLeftToTopRightBack") {
