        ...
        for (let m = 0; m < joinedGroups.length; m++) {
            ...
            for (let l = 0; l < uncheckedGroups.length; l++) {
                ...
                if (uncheckedGroups[l] != joinerGroupsToJoinUniqArray[i]) {
                    ...
                    console.log(joinedGroups[0][0])
                    for (let k = 0; k < joinedGroups[m].length; k++) {
                        console.log("bang");
                        if ((joinedGroups[m][k] == uncheckedGroups[l][0] || joinedGroups[m][k] == uncheckedGroups[l][1]) && uncheckedGroups[l].merged == false) {
                            joinedGroups[m].push(uncheckedGroups[l][0]);
                            joinedGroups[m].push(uncheckedGroups[l][1]);
