...
class TruchetTile {
    ...
    createTileB()
    {
        ...
        this.createPieSlice({ centreX: 0, centreY: this.tileWidth, startAngleRadians: 0 , sweepAngleRadians: degrees_to_radians(90), radius: (this.tileWidth / 2) + (this.strokeWidth / 2), fillColour: "#000" } );
        this.createPieSlice({ centreX: 0, centreY: this.tileWidth, startAngleRadians: 0 , sweepAngleRadians: degrees_to_radians(90), radius: (this.tileWidth / 2) - (this.strokeWidth / 2), fillColour: "#FFF" } );
    }
