    ...
    for (let i = 0; i < joinerGroupsToJoinUniqArray.length; i++) {
        ...
        for(let j = 0; j < joinerArray.length; j++) {
            ...
            for(let k = 0; k < joinerArray[j].length; k++) {
                if (joinerArray[j][k] == joinerGroupsToJoinUniqArray[i].group[0] || joinerArray[j][k] == joinerGroupsToJoinUniqArray[i].group[1]) {
        ...
        j//oinerGroupsToJoinUniqArray[i].checked = true;
